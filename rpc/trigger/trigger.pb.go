...
func (x *TriggerManual) GetArgs() []byte {
	if x != nil {
		return x.Args
	}
	return nil
...
func (x *TriggerWeb) GetArgs() []byte {
	if x != nil {
		return x.Args
	}
	return nil
...
var file_trigger_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x61, 0x72, 0x67, 0x73, 0x22, 0x2c, 0x0a, 0x0f, 0x4d, 0x61,
	...
	0x28, 0x0c, 0x52, 0x04, 0x61, 0x72, 0x67, 0x73, 0x22, 0x29, 0x0a, 0x0c, 0x57, 0x65, 0x62, 0x54,
	...
	,
...
var file_trigger_proto_goTypes = []interface{}{
	(*TriggerManual)(nil),   // 0: redsail.bosn.TriggerManual
	(*ManualTriggered)(nil), // 1: redsail.bosn.ManualTriggered
	(*TriggerWeb)(nil),      // 2: redsail.bosn.TriggerWeb
	(*WebTriggered)(nil),    // 3: redsail.bosn.WebTriggered
}
var file_trigger_proto_depIdxs = []int32{
	0, // 0: redsail.bosn.Trigger.Manual:input_type -> redsail.bosn.TriggerManual
	2, // 1: redsail.bosn.Trigger.Web:input_type -> redsail.bosn.TriggerWeb
	1, // 2: redsail.bosn.Trigger.Manual:output_type -> redsail.bosn.ManualTriggered
	3, // 3: redsail.bosn.Trigger.Web:output_type -> redsail.bosn.WebTriggered
