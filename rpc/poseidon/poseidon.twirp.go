...
/*
Package poseidon is a generated twirp stub package.
...
// NewPoseidonProtobufClient creates a Protobuf client that implements the Poseidon interface.
// It communicates using Protobuf and can be configured with a custom HTTPClient.
func NewPoseidonProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) Poseidon {
...
func (c *poseidonProtobufClient) Charts(ctx context.Context, in *Repo) (*ChartsResponse, error) {
	...
	if c.interceptor != nil {
		caller = func(ctx context.Context, req *Repo) (*ChartsResponse, error) {
			...
			if resp != nil {
				typedResp, ok := resp.(*ChartsResponse)
				if !ok {
					return nil, twirp.InternalError("failed type assertion resp.(*ChartsResponse) when calling interceptor")
				}
...
func (c *poseidonProtobufClient) callCharts(ctx context.Context, in *Repo) (*ChartsResponse, error) {
	out := new(ChartsResponse)
...
func (c *poseidonProtobufClient) Repos(ctx context.Context, in *ReposRequest) (*ReposResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "redsail.bosn")
	ctx = ctxsetters.WithServiceName(ctx, "Poseidon")
	ctx = ctxsetters.WithMethodName(ctx, "Repos")
	caller := c.callRepos
	if c.interceptor != nil {
		caller = func(ctx context.Context, req *ReposRequest) (*ReposResponse, error) {
			resp, err := c.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					typedReq, ok := req.(*ReposRequest)
					if !ok {
						return nil, twirp.InternalError("failed type assertion req.(*ReposRequest) when calling interceptor")
					}
					return c.callRepos(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*ReposResponse)
				if !ok {
					return nil, twirp.InternalError("failed type assertion resp.(*ReposResponse) when calling interceptor")
				}
				return typedResp, err
			}
			return nil, err
...
// NewPoseidonJSONClient creates a JSON client that implements the Poseidon interface.
// It communicates using JSON and can be configured with a custom HTTPClient.
func NewPoseidonJSONClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) Poseidon {
	if c, ok := client.(*http.Client); ok {
		client = withoutRedirects(c)
	}
...
func (c *poseidonJSONClient) Charts(ctx context.Context, in *Repo) (*ChartsResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "redsail.bosn")
	ctx = ctxsetters.WithServiceName(ctx, "Poseidon")
	ctx = ctxsetters.WithMethodName(ctx, "Charts")
	caller := c.callCharts
...
func (c *poseidonJSONClient) callCharts(ctx context.Context, in *Repo) (*ChartsResponse, error) {
	out := new(ChartsResponse)
...
// =======================
// Poseidon Server Handler
// =======================

type poseidonServer struct {
	Poseidon
	interceptor      twirp.Interceptor
...
// NewPoseidonServer builds a TwirpServer that can be used as an http.Handler to handle
// HTTP requests that are routed to the right method in the provided svc implementation.
// The opts are twirp.ServerOption modifiers, for example twirp.WithServerHooks(hooks).
func NewPoseidonServer(svc Poseidon, opts ...interface{}) TwirpServer {
	...
	for _, opt := range opts {
		...
		case nil: // backwards compatibility, allow nil value for the argument
			continue
		default:
			panic(fmt.Sprintf("Invalid option type %T on NewPoseidonServer", o))
		}
	}
...
func (s *poseidonServer) writeError(ctx context.Context, resp http.ResponseWriter, err error) {
	writeError(ctx, resp, err, s.hooks)
}

// PoseidonPathPrefix is a convenience constant that could used to identify URL paths.
// Should be used with caution, it only matches routes generated by Twirp Go clients,
// that add a "/twirp" prefix by default, and use CamelCase service and method names.
// More info: https://twitchtv.github.io/twirp/docs/routing.html
const PoseidonPathPrefix = "/twirp/redsail.bosn.Poseidon/"

func (s *poseidonServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	ctx := req.Context()
	ctx = ctxsetters.WithPackageName(ctx, "redsail.bosn")
	ctx = ctxsetters.WithServiceName(ctx, "Poseidon")
	...
	if pkgService != "redsail.bosn.Poseidon" {
...
func (s *poseidonServer) serveCharts(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
...
func (s *poseidonServer) serveChartsJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Charts")
	...
	handler := s.Poseidon.Charts
	if s.interceptor != nil {
		handler = func(ctx context.Context, req *Repo) (*ChartsResponse, error) {
			resp, err := s.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					...
					return s.Poseidon.Charts(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*ChartsResponse)
	...
	// Call service method
	var respContent *ChartsResponse
	func() {
...
func (s *poseidonServer) serveChartsProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Charts")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *poseidonServer) serveRepos(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveReposJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveReposProtobuf(ctx, resp, req)
	default:
		msg := fmt.Sprintf("unexpected Content-Type: %q", req.Header.Get("Content-Type"))
		twerr := badRouteError(msg, req.Method, req.URL.Path)
		s.writeError(ctx, resp, twerr)
...
func (s *poseidonServer) serveReposJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Repos")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	handler := s.Poseidon.Repos
	if s.interceptor != nil {
		handler = func(ctx context.Context, req *ReposRequest) (*ReposResponse, error) {
			resp, err := s.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					typedReq, ok := req.(*ReposRequest)
					if !ok {
					...
					return s.Poseidon.Repos(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*ReposResponse)
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *ReposResponse and nil error while calling Repos. nil responses are not supported"))
		return
	}
...
func (s *poseidonServer) serveReposProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Repos")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *poseidonServer) ServiceDescriptor() ([]byte, int) {
	return twirpFileDescriptor0, 0
}

func (s *poseidonServer) ProtocGenTwirpVersion() string {
	return "v7.1.0"
}
...
func (s *poseidonServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "redsail.bosn", "Poseidon")
}
...
var twirpFileDescriptor0 = []byte{
	...
	,
}
