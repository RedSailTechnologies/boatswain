...
var file_deployment_proto_rawDesc = []byte{
	...
	0x6d, 0x6c, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x79, 0x61, 0x6d, 0x6c, 0x32, 0xcb,
	0x03, 0x0a, 0x0a, 0x44, 0x65, 0x70, 0x6c, 0x6f, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x12, 0x49, 0x0a,
	...
	0x65, 0x6e, 0x74, 0x54, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x64, 0x42, 0x40, 0x5a, 0x3e,
...
var file_deployment_proto_goTypes = []interface{}{
	...
	(*ReadDeployments)(nil),       // 8: redsail.bosn.ReadDeployments
	(*DeploymentReadSummary)(nil), // 9: redsail.bosn.DeploymentReadSummary
	(*DeploymentsRead)(nil),       // 10: redsail.bosn.DeploymentsRead
	(*TemplateDeployment)(nil),    // 11: redsail.bosn.TemplateDeployment
	(*DeploymentTemplated)(nil),   // 12: redsail.bosn.DeploymentTemplated
}
var file_deployment_proto_depIdxs = []int32{
	9,  // 0: redsail.bosn.DeploymentsRead.deployments:type_name -> redsail.bosn.DeploymentReadSummary
	...
	8,  // 5: redsail.bosn.Deployment.All:input_type -> redsail.bosn.ReadDeployments
	11, // 6: redsail.bosn.Deployment.Template:input_type -> redsail.bosn.TemplateDeployment
	...
	12, // 12: redsail.bosn.Deployment.Template:output_type -> redsail.bosn.DeploymentTemplated
