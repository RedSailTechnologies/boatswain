...
type ClusterCreated struct {
	...
	Uuid string `protobuf:"bytes,1,opt,name=uuid,proto3" json:"uuid,omitempty"` // the uuid of the cluster, used when setting up the agent
}
...
type ClusterRead struct {
	...
	Uuid  string `protobuf:"bytes,1,opt,name=uuid,proto3" json:"uuid,omitempty"`    // unique id of the cluster
	Name  string `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`    // name of the cluster
	Ready bool   `protobuf:"varint,3,opt,name=ready,proto3" json:"ready,omitempty"` // server ready status, based on agent status
}
...
type TokenRead struct {
	...
	Token string `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"` // the token for this cluster
}
...
var file_cluster_proto_rawDesc = []byte{
	...
	,
	...
	,
...
var file_cluster_proto_goTypes = []interface{}{
	...
	(*ReadToken)(nil),        // 12: redsail.bosn.ReadToken
	(*TokenRead)(nil),        // 13: redsail.bosn.TokenRead
}
var file_cluster_proto_depIdxs = []int32{
	...
	12, // 7: redsail.bosn.Cluster.Token:input_type -> redsail.bosn.ReadToken
	1,  // 8: redsail.bosn.Cluster.Create:output_type -> redsail.bosn.ClusterCreated
	3,  // 9: redsail.bosn.Cluster.Update:output_type -> redsail.bosn.ClusterUpdated
	5,  // 10: redsail.bosn.Cluster.Destroy:output_type -> redsail.bosn.ClusterDestroyed
	7,  // 11: redsail.bosn.Cluster.Read:output_type -> redsail.bosn.ClusterRead
	9,  // 12: redsail.bosn.Cluster.Find:output_type -> redsail.bosn.ClusterFound
	11, // 13: redsail.bosn.Cluster.All:output_type -> redsail.bosn.ClustersRead
	13, // 14: redsail.bosn.Cluster.Token:output_type -> redsail.bosn.TokenRead
